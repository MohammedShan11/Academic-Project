...
class _TeacherSchedulePageState extends State<TeacherSchedulePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("New Schedule", style: appbar,),
                      ...
                      child: GestureDetector(
                        onTap: () {
                          FirebaseFirestore.instance.collection('booking').doc(
                              widget.bookid).update({
                            'book status': 2,

                          }).then((value) =>
                              showsnackbar("successfully  Accepted"));
                        },
                        child: Container(
                      ...
                      onTap: () {
                        FirebaseFirestore.instance.collection('booking').doc(
                          ...
                          'book status': 0,
                            ...
                            showsnackbar("successfully  Rejected"));
                      },
                      child: Container(
                        decoration: BoxDecoration(
                          color: Colors.red,
