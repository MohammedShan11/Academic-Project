...
class ViewAllPagePop extends StatefulWidget {
  var name;
  var location;
  var sname;
  var semail;
  ...
  @override
  _ViewAllPagePopState createState() => _ViewAllPagePopState();
}

class _ViewAllPagePopState extends State<ViewAllPagePop> {
  @override
